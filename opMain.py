...
start_dt = datetime.date(byr,bmon,bday)  # custommized your starting date and end date here
...
####################################################################################################################
        ...
        ### Model ##########################################################################################
        modelPredict(UTC_input,mdl_type, filter_NGLE_PSGLGS, full_extent, predictors, Mdl,shape_feature)
        print("\n")
